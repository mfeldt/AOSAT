...
pyfits.writeto(os.path.join('ExampleFrameserver','exmpl_frame1.fits'),ecube[0])
pyfits.writeto(os.path.join('ExampleFrameserver','exmpl_frame2.fits'),ecube[1:8])
pyfits.writeto(os.path.join('ExampleFrameserver','exmpl_frame9.fits'),ecube[8:])
...
phaseunit       = "radians"              # unit of phase screens
