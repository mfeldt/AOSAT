...
class sps_analyzer(dmy_analyzer):
    """Determine the spatial power spectrum
    ...
    Attributes
    ----------
    mask : 2D ndarray (float)
        Apodization mask generated from puppil
    f_spatial : 1D ndarray (float)
        Spatial frequency vector [1/m]
    ps_psd : 1D ndarray (float)
        Power spectral density at f_spatial [nm^2/m^-1]
